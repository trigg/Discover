...
Got a question about development, bug reports or a feature request?
[Join our Discord!](https://discord.gg/jRKWMuDy5V) or open an [issue on GitHub](https://github.com/trigg/Discover/issues)
...
This will disallow drawing to the outer desktop and instead connect directly to Gamescope.
...
Visit our [Flathub page](https://flathub.org/apps/details/io.github.trigg.discover_overlay) or install via command line:
...
A compositor is strongly advised, but compatibility exists for X11 sessions without a compositor.
...
I often use some terms interchangeably:
